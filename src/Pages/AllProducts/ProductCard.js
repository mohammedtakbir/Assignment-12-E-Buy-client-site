                ...
                <div className="p-1 mt-5">
                    ...
                    <div className='flex justify-between items-center mt-7'>
                        ...
                        {/* <label
                            ...
                            className="cursor-pointer inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blgrayue-300"
                        >
                            Book Now
