...
const NewArrivalProduct = ({ newArrivalProduct }) => {
    const { image, model_name, resale_price } = newArrivalProduct;
    ...
    return (
        <div className='hover:shadow-xl duration-300 border border-gray-100 shadow-md cursor-pointer rounded-md text-center p-5 md:mx-0 mx-3'>
            ...
            <label className="cursor-pointer inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blgrayue-300">
                Checkout Now
