            ...
            <div className="bg-white border border-gray-200 rounded-lg shadow-md h-full p-5">
                ...
                <div className="p-1 mt-5">
                    ...
                    <div className='lg:flex justify-between mb-2'>
                        ...
                        <p className='text-sm text-gray-500 lg:w-1/2'>Seller: {seller[0].name} {seller[0].verify ? <HiCheckCircle className='text-blue-500 text-lg inline' /> : ''}</p>
                    </div>
                    <div className='lg:flex  justify-between mb-2'>
                    ...
                    <Link href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blgrayue-300 mt-7">
                        Book Now
